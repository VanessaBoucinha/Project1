...
#change columns to a numeric
final_Date$Global_active_power=as.numeric(as.character(final_Date$Global_active_power))
final_Date$Voltage=as.numeric(as.character(final_Date$Voltage))
...
final_Date$Global_reactive_power=as.numeric(as.character(final_Date$Global_reactive_power))
...
#plot the graph
par(mfrow=c(2,2),mar=c(4,4,2,2),win.graph(width = 4.80,height = 4.80))
plot(Date_Time,final_Date$Global_active_power,type = "l", ylab="Global Active Power (kilowatts)", xlab = "" ,cex.axis=0.7,cex.lab=0.7)
plot(Date_Time,final_Date$Voltage,type = "l", ylab="Voltage", xlab = "datetime" ,cex.axis=0.7,cex.lab=0.7)
plot(Date_Time,final_Date$Sub_metering_1,type = "l", xlab = "", ylab = "Energy sub metering",cex.axis=0.7,cex.lab=0.7)
...
plot(Date_Time,final_Date$Global_reactive_power,type = "l", ylab="Global_reactive_power", xlab = "datatime",cex.axis=0.7, cex.lab=0.7 )
